  ...
  return (
    <main className="min-h-screen bg-gray-900 px-6 py-16 text-white">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="mt-10 text-center text-slate-500 italic">Desarrollado por <span className="text-white font-semibold">Sebastian Rojas</span> para tu seguridad digital.</p>
      </div>
