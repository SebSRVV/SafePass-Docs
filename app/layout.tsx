        ...
        <nav className="bg-gray-800 px-6 py-4">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <ul className="flex gap-6 text-sm sm:text-base">
              <li>
                <Link href="/rsa" className="hover:text-sky-300 transition-colors">
                  🔑 RSA
                </Link>
              </li>
              <li>
                <Link href="/docs" className="hover:text-sky-300 transition-colors">
                  📄 Documentos
                </Link>
              </li>
              <li>
                <Link href="/vault" className="hover:text-sky-300 transition-colors">
                  🗝️ Vault
                </Link>
              </li>
              <li>
